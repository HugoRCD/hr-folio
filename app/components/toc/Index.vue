...
<template>
  ...
  >
    <div
      ...
      :class="[
        isOpen ? 'bg-primary/80 backdrop-blur-lg shadow-md border border-(--ui-border)/20 p-4' : 'p-0 border-transparent',
        isMobile && !isOpen ? 'bg-primary/80 backdrop-blur-lg shadow-md border (--ui-border)/20 p-2 py-4 scale-50 origin-right' : ''
      ]"
